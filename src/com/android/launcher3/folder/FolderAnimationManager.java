...
public class FolderAnimationManager {
    ...
    public AnimatorSet getAnimator() {
        ...
        int initialColor = ColorUtils.setAlphaComponent(mDeviceProfile.folderIconColor, LawnchairUtilsKt.getFolderPreviewAlpha(mContext));
        int finalColor = mDeviceProfile.folderBackgroundColor;
